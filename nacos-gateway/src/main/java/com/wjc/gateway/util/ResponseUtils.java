...
public class ResponseUtils {
     ...
     * @param result
     */
    public static void out(ServletResponse response, ResultBody result) {
    ...
    public static void getResponse(HttpServletResponse httpServletResponse, String msg, Integer status){
        ...
        try {
            ...
            writer.print(JSONObject.toJSONString(new ResultBody(status.toString(), msg,null)));
        } catch (IOException e) {
